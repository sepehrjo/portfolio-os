...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Sepehr Jokanian" },
      { property: "og:type", content: "website" },
      { property: "og:url", content: "https://sepehr.am" },
      { property: "og:image", content: "https://sepehr.am/og-image.jpg" },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "630" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:site", content: "@sepehrjo" },
      { name: "twitter:image", content: "https://sepehr.am/og-image.jpg" },
    ],
    links: [
      {
        rel: "preconnect",
